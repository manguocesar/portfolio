...
export const projects: Project[] = [
  { 
    ...
    key_techs: ["React Native", "React Admin", "Express", "mongo", "Material UI"],
  },
  { 
    name: "Meldd",
    ...
    key_techs: ["React Native", "expo", "Material UI", "graphQL", "i18next", "postGreSQL"],
  },
  { 
  ...
  },
  {
    ...
    category: ["react", "materialUI", "typescript", "express", "postGreSQL", "AWS"],
