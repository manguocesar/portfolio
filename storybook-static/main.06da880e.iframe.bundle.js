  ...
  [792],
  {
    ...
    './stories lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/stories(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\.mdx)$':
      (module, __unused_webpack_exports, __webpack_require__) => {
        var map = {
          './Configure.mdx': ['./stories/Configure.mdx', 844, 908, 707],
        };
    ...
    './stories lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/stories(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\.stories\\.(js%7Cjsx%7Cmjs%7Cts%7Ctsx))$':
      (module, __unused_webpack_exports, __webpack_require__) => {
        var map = {
          ...
          './Header.stories': ['./stories/Header.stories.ts', 200, 384],
          './Header.stories.ts': ['./stories/Header.stories.ts', 200, 384],
          './Page.stories': ['./stories/Page.stories.ts', 200, 226],
          './Page.stories.ts': ['./stories/Page.stories.ts', 200, 226],
        };
        function webpackAsyncContext(req) {
          if (!__webpack_require__.o(map, req))
            return Promise.resolve().then(() => {
