...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        <Sidebar />
        <div className="shadow-custom-light dark:border-orange dark:bg-dark-500 dark:shadow-custom-dark col-span-12 flex flex-col overflow-hidden rounded-2xl border bg-white transition duration-1000 lg:col-span-9">
          <Navbar />
          {children}
        </div>
      </body>
