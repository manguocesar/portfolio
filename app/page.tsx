  ...
  return (
    <div className="flex flex-grow flex-col pt-1">
      <div className="flex flex-row px-6">
        <h6 className="xl:10/12 my-3 hidden w-7/12 text-base font-medium transition duration-500 ease-in-out hover:text-gray-500 md:block md:w-7/12 lg:w-9/12">
          {introduction}
        </h6>
      ...
      <div className="dark:bg-dark-100 flex-grow bg-gray-400 p-4 sm:mt-5">
        <h4 className="my-1 text-2xl font-bold tracking-wide transition duration-600 ease-in-out hover:text-white">
          What I do:
        </h4>
